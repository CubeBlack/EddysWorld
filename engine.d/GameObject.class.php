<?php
	class GameObject{
		...
		static function add(){
			$id = DB::queryId("insert into ew_go set criacao = now();");
			return $id;

		}
		function list($r = ''){
			$retorno =  DB::queryObject('select * from ew_go');
			...
			// se o retorno não for reconhecido;
			return $retorno;
		}
		function listAsId($r = 'dump'){

		}
		function listAsSquare($r = 'dump'){
